...
```php
function issueAdvanceInvoice(string $subscriptionId, ?IssueAdvanceInvoiceRequest $body = null): ?Invoice
```
...
```php
function readAdvanceInvoice(string $subscriptionId): ?Invoice
```
...
```php
function voidAdvanceInvoice(string $subscriptionId, ?VoidInvoiceRequest $body = null): ?Invoice
```
