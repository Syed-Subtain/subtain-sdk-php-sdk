...
| `createdAt` | `?string` | Optional | Timestamp indicating when this product was created | getCreatedAt(): ?string | setCreatedAt(?string createdAt): void |
| `updatedAt` | `?string` | Optional | Timestamp indicating when this product was last updated | getUpdatedAt(): ?string | setUpdatedAt(?string updatedAt): void |
...
| `archivedAt` | `?string` | Optional | Timestamp indicating when this product was archived | getArchivedAt(): ?string | setArchivedAt(?string archivedAt): void |
