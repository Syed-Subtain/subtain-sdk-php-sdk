...
class CreateSubscription implements \JsonSerializable
{
    ...
    /**
     * @var CustomPriceUsedForSubscriptionCreateUpdate|null
     */
    private $customPrice;
     ...
     */
    private $prepaidSubscriptionConfiguration;
     ...
     * subscription
     */
    public function getCustomPrice(): ?CustomPriceUsedForSubscriptionCreateUpdate
    {
     ...
     * @maps custom_price
     */
    public function setCustomPrice(?CustomPriceUsedForSubscriptionCreateUpdate $customPrice): void
    {
     ...
     *
     * @maps components
     * @mapsBy anyOf(oneOf(CreateSubscriptionComponent)[],null)
     *
    ...
    /**
     * Returns Prepaid Subscription Configuration.
     */
    public function getPrepaidSubscriptionConfiguration(): ?UpsertPrepaidConfiguration
    {
        return $this->prepaidSubscriptionConfiguration;
    }

    /**
     * Sets Prepaid Subscription Configuration.
     *
     * @maps prepaid_subscription_configuration
     */
    public function setPrepaidSubscriptionConfiguration(
     ...
     */
    public function getPreviousBillingAt(): ?string
    {
     ...
     */
    public function setPreviousBillingAt(?string $previousBillingAt): void
    {
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        if (isset($this->components)) {
            $json['components']                            =
                ApiHelper::getJsonHelper()->verifyTypes(
                    $this->components,
                    'anyOf(oneOf(CreateSubscriptionComponent)[],null)'
                );
        }
        ...
        if (isset($this->prepaidSubscriptionConfiguration)) {
            $json['prepaid_subscription_configuration']    = $this->prepaidSubscriptionConfiguration;
        }
        if (isset($this->previousBillingAt)) {
            $json['previous_billing_at']                   = $this->previousBillingAt;
        }
