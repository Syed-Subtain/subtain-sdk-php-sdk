...
class ProformaCustomField implements \JsonSerializable
{
     ...
     * Returns Owner Id.
     */
    public function getOwnerId(): ?float
    {
        return $this->ownerId;
    }
     ...
     * @maps owner_id
     */
    public function setOwnerId(?float $ownerId): void
    {
     ...
     */
    public function getMetadatumId(): ?float
    {
     ...
     * @maps metadatum_id
     */
    public function setMetadatumId(?float $metadatumId): void
    {
