...
class Subscription implements \JsonSerializable
{
    ...
    /**
     * Returns State.
     * The current state of the subscription. Please see the documentation for [Subscription States](https:
     * //help.chargify.com/subscriptions/subscription-states.html)
     */
     ...
     * @mapsBy anyOf(oneOf(CancellationMethod),null)
     * @factory \AdvancedBillingLib\Models\CancellationMethod::checkValue CancellationMethod
     */
    ...
    {
        if (count($this->paymentCollectionMethod) == 0) {
            return null;
        }
        return $this->paymentCollectionMethod['value'];
    }
     ...
     * @mapsBy anyOf(oneOf(PaymentCollectionMethod),null)
     * @factory \AdvancedBillingLib\Models\PaymentCollectionMethod::checkValue PaymentCollectionMethod
     */
    public function setPaymentCollectionMethod(?string $paymentCollectionMethod): void
    {
        $this->paymentCollectionMethod['value'] = $paymentCollectionMethod;
    }

    /**
     * Unsets Payment Collection Method.
     */
    public function unsetPaymentCollectionMethod(): void
    {
     ...
     * Returns Group.
     */
    public function getGroup(): ?SubscriptionGroupInlined
    {
     ...
     *
     * @maps group
     * @mapsBy anyOf(oneOf(SubscriptionGroupInlined),null)
     */
    public function setGroup(?SubscriptionGroupInlined $group): void
    {
    ...
    public function jsonSerialize(bool $asArrayWhenEmpty = false)
    {
        ...
        if (!empty($this->cancellationMethod)) {
            $json['cancellation_method']                   =
                ApiHelper::getJsonHelper()->verifyTypes(
                    ...
                    'anyOf(oneOf(CancellationMethod),null)',
                    [
                        '\AdvancedBillingLib\Models\CancellationMethod::checkValue CancellationMethod'
                    ]
                );
        }
        ...
        if (isset($this->previousState)) {
            $json['previous_state']                        = $this->previousState;
        }
        ...
        if (!empty($this->paymentCollectionMethod)) {
            $json['payment_collection_method']             =
                ApiHelper::getJsonHelper()->verifyTypes(
                    $this->paymentCollectionMethod['value'],
                    'anyOf(oneOf(PaymentCollectionMethod),null)',
                    [
                        '\AdvancedBillingLib\Models\PaymentCollectionMethod::checkValue PaymentCollectionMethod'
                    ]
                );
        }
        ...
        if (!empty($this->group)) {
            $json['group']                                 =
                ApiHelper::getJsonHelper()->verifyTypes(
                    $this->group['value'],
                    'anyOf(oneOf(SubscriptionGroupInlined),null)'
                );
        }
        ...
        if (isset($this->productPricePointType)) {
            $json['product_price_point_type']              = $this->productPricePointType;
        }
