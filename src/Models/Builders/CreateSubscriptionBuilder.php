...
class CreateSubscriptionBuilder
{
     ...
     */
    public function productPricePointId(?string $value): self
    {
     ...
     */
    public function customPrice(?CustomPriceUsedForSubscriptionCreateUpdate $value): self
    {
    ...
    /**
     * Sets prepaid subscription configuration field.
     */
    public function prepaidSubscriptionConfiguration(?UpsertPrepaidConfiguration $value): self
    {
        $this->instance->setPrepaidSubscriptionConfiguration($value);
        return $this;
    }
     ...
     */
    public function previousBillingAt(?string $value): self
    {
